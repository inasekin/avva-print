...
?>
    <? if ($itemHasDetailUrl): ?>
    <a class="product-item-image-wrapper product-image" href="<?=$item['DETAIL_PAGE_URL']?>" title="<?=$imgTitle?>"
	...
	<? endif; ?>
        ...
        <img  class="product-item-image-original" src='<?=$item['PREVIEW_PICTURE']['SRC']?>' alt='' id="<?=$itemIds['PICT']?>" style="<?=($showSlider ? 'display: none;' : '')?>">
		<?
        if ($item['SECOND_PICT'])
        {
            $bgImage = !empty($item['PREVIEW_PICTURE_SECOND']) ? $item['PREVIEW_PICTURE_SECOND']['SRC'] : $item['PREVIEW_PICTURE']['SRC'];
            ?>
            <img  class="product-item-image-alternative" src='<?=$bgImage?>' alt='' id="<?=$itemIds['SECOND_PICT']?>" style="<?=($showSlider ? 'display: none;' : '')?>">
            <?
        }
...
<? endif; ?>
    ...
    <div class="product-item-title">
        <? if ($itemHasDetailUrl): ?>
        <a href="<?=$item['DETAIL_PAGE_URL']?>" title="<?=$productTitle?>" class="product__name">
            <? endif; ?>
            <?=$productTitle?>
            <? if ($itemHasDetailUrl): ?>
        </a>
            ...
            switch ($blockName)
            {
                case 'price': ?>
                    <div class="product-item-info-container product-item-price-container" data-entity="price-block">
                        ...
                        {
                            ?>
                            <span class="product-item-price-old product__price" id="<?=$itemIds['PRICE_OLD']?>"
                        ...
                        ?>
                        <span class="product-item-price-current product__price" id="<?=$itemIds['PRICE']?>">
							<?
                            if (!empty($price))
                            {
                    ...
                    <div class="product-item-info-container product-item-hidden" data-entity="buttons-block">
                        ...
                        if (!$haveOffers)
                        {
                            if ($actualItem['CAN_BUY'])
                            {
                                ...
                                <div class="product-item-button-container" id="<?=$itemIds['BASKET_ACTIONS']?>">
                                    <a class="btn btn-default product__btn <?=$buttonSizeClass?>" id="<?=$itemIds['BUY_LINK']?>"
                            ...
                            else
                            {
                                ...
                                <div class="product-item-button-container">
                                    ...
                                    ?>
                                    <a class="btn btn-link product__btn <?=$buttonSizeClass?>"
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ?>
                                <div class="product-item-button-container">
                                    <a class="btn btn-default product__btn <?=$buttonSizeClass?>" href="<?=$item['DETAIL_PAGE_URL']?>">
