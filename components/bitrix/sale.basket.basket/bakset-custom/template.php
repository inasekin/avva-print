            ...
            <div id="basket-root" class="bx-basket bx-<?= $arParams['TEMPLATE_THEME'] ?> bx-step-opacity"
                ...
                <div id="basket-items-list-wrapper">
                    <div class="cart__header">
                        <div class="cart__title">Состав заказа</div>
                        <div class="cart__count">
                            <div class="basket-items-list-header-filter">
                                <div href="javascript:void(0)" class=" active"
...
<!--        <div class="cart__header">-->
<!--            <div class="cart__title">Состав заказа</div>-->
<!--            <div class="cart__count">В корзине 2 товара</div>-->
<!--        </div>-->
...
<!--                            <img src="img/product-card-thumbnail.jpg" alt="">-->
<!--                        </div>-->
<!--                        <div class="product-card__content-wrapper">-->
<!--                            <div class="product-card__content">-->
<!--                                <div class="product-card__title">Картина с рамой, Зебра</div>-->
<!--                                <div class="product-card__property">140x100 см</div>-->
<!--                                <div class="product-card__property">1 шт.</div>-->
<!--                                <div class="product-card__price">4 699 руб</div>-->
<!--                            </div>-->
<!--                            <div class="cart-item__buttons">-->
<!--                                <div class="cart-item__button counter-button">-->
<!--                                    <div class="counter-button__plus"></div>-->
<!--                                    <div class="counter-button__count">1</div>-->
<!--                                    <div class="counter-button__minus"></div>-->
<!--                                </div>-->
<!--                                <div class="cart-item__button cart-item__delete">Удалить</div>-->
<!--                            </div>-->
<!--                        </div>-->
<!--                    </div>-->
<!--                </div>-->
...
<!--            <div class="cart__total">Итого: 6 698 руб</div>-->
