...
<script id="basket-total-template" type="text/html">
    <div class="cart__footer" data-entity="basket-checkout-aligner">
        <?
        ...
        <div class="cart__total">
            <span class=""><?= Loc::getMessage('SBB_TOTAL') ?>:</span>
            ...
            <span class="">
                        ...
                        {{#DISCOUNT_PRICE_FORMATED}}
                        <span class="basket-coupon-block-total-price-difference">
        ...
        <div class="cart__submit">
            <a class="btn btn--blue basket-btn-checkout{{#DISABLE_CHECKOUT}} disabled{{/DISABLE_CHECKOUT}}"
