...
$propertyTelephoneId = 77;
$propertyMessageId = 78;

?>

<form action="<?=POST_FORM_ACTION_URI?>" method="POST" name="iblock_add">
    <?=bitrix_sessid_post() ?>
    <div class="header-form__title" style="color: #333333">Хотите заказать услугу у нас?</div>
    <div class="header-form__text" style="color: #333333">
        Наш специалист точно поможет. Просто оставьте заявку на нашем сайте.
    </div>
    <div class="header-form__form-step">
        <div class="header-form__form form">
            ...
            <div class="form__textarea">
                <textarea placeholder="Расскажите какую услугу вы хотели бы получить" name="PROPERTY[<?=$propertyMessageId?>][0]" value="" id="d[3]"></textarea>
                <div class="form__textarea-button"></div>
            </div>
            <!-- поля заказа скрытые конец -->

            <div class="form__privacy" style="color: #333333">Нажимая на кнопку, вы даете согласие на обработку персональных данных</div>
            <div class="header-form__submit form__submit">
                <input type="submit" class="btn btn--blue" name="iblock_submit" value="Заказать" style="text-transform: uppercase">
            </div>
        </div>
    </div>
