...
<div class="order-form__section" style="display: none;">
    <div class="order-form__section-title">Способ доставки</div>
    <div class="form">
        <div class="form__row">
            <div class="form__column">
                <div class="form__radio">
                    <div class="form__radio-item">
                        <input type="radio" value="1" name="delivery" id="delivery1">
                        <label for="delivery1">
                            <p>Доставка курьером от 500 руб.</p>
                        </label>
                    </div>
                </div>
            </div>
            <div class="form__column">
                <div class="form__radio-item">
                    <input type="radio" value="1" name="delivery" id="delivery2">
                    <label for="delivery2">
                        <p>Самовывоз</p>
                    </label>
                </div>
...
<div class="bx_section order-form__section">
	<?
