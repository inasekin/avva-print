...
<!--                                <label>-->
<!--                                    <p>--><?//=$arSource[1]['NAME']?><!--</p>-->
<!--                                    <input type="text" maxlength="250" size="--><?//=$arSource[1]["SIZE1"]?><!--" value="--><?//=$arSource[1]["VALUE"]?><!--" name="--><?//=$arSource[1]["FIELD_NAME"]?><!--" id="--><?//=$arSource[1]["FIELD_NAME"]?><!--" />-->
<!--                                </label>-->
<!--                            </div>-->
<!--                        </div>-->
<!--                        <div class="form__column">-->
...
<!--                                <label>-->
<!--                                    <p>--><?//=$arSource[2]['NAME']?><!--</p>-->
<!--                                    <input type="text" maxlength="250" size="--><?//=$arSource[2]["SIZE1"]?><!--" value="--><?//=$arSource[2]["VALUE"]?><!--" name="--><?//=$arSource[2]["FIELD_NAME"]?><!--" id="--><?//=$arSource[2]["FIELD_NAME"]?><!--" />-->
<!--                                </label>-->
<!--                            </div>-->
<!--                        </div>-->
<!--                    </div>-->
...
<!--                                <label>-->
<!--                                    <p>--><?//=$arSource[3]['NAME']?><!--</p>-->
<!--                                    <input type="text" maxlength="250" size="--><?//=$arSource[3]["SIZE1"]?><!--" value="--><?//=$arSource[3]["VALUE"]?><!--" name="--><?//=$arSource[3]["FIELD_NAME"]?><!--" id="--><?//=$arSource[3]["FIELD_NAME"]?><!--" />-->
<!--                                </label>-->
<!--                            </div>-->
<!--                        </div>-->
<!--                        <div class="form__column">-->
...
<!--                                <label>-->
<!--                                    <p>--><?//=$arSource[4]['NAME']?><!--</p>-->
<!--                                    <input type="text" maxlength="250" size="--><?//=$arSource[4]["SIZE1"]?><!--" value="--><?//=$arSource[4]["VALUE"]?><!--" name="--><?//=$arSource[4]["FIELD_NAME"]?><!--" id="--><?//=$arSource[4]["FIELD_NAME"]?><!--" />-->
<!--                                </label>-->
<!--                            </div>-->
<!--                        </div>-->
<!--                    </div>-->
                                ...
                                <div class="form__column">
                                    <div class="form__input">
                                        <label>
                                            ...
                                            <input type="text" maxlength="250" size="<?=$arProperties["SIZE1"]?>" value="<?=$arProperties["VALUE"]?>" name="<?=$arProperties["FIELD_NAME"]?>" id="<?=$arProperties["FIELD_NAME"]?>" placeholder="Введите <?=$arProperties['NAME']?>" />
                                        </label>
                                    </div>
                                </div>
                            </div>
...
<!--                            </pre>-->
						...
						elseif ($arProperties["TYPE"] == "TEXTAREA")
						{
                            ...
                            <div class="form__textarea">
                                <p><?=$arProperties["NAME"]?></p>
                                <textarea rows="<?=$rows?>" cols="<?=$arProperties["SIZE1"]?>" name="<?=$arProperties["FIELD_NAME"]?>" id="<?=$arProperties["FIELD_NAME"]?>" placeholder="Введите адрес"><?=$arProperties["VALUE"]?></textarea>
