...
<!--    <div class="order-form__section-title">Способ оплаты</div>-->
<!--    <div class="form">-->
<!--        <div class="form__select">-->
<!--            <p>Выберите способ оплаты</p>-->
<!--            <div class="select select-paysystem">-->
<!--                <div class="select__header">Способ оплаты</div>-->
<!--                <div class="select__items">-->
<!--                    <div class="select__item" data-active="">Item 1</div>-->
<!--                </div>-->
<!--            </div>-->
<!--        </div>-->
<!--    </div>-->
<!--</div>-->
	...
	<div class="bx_section order-form__section">
        <div class="order-form__section-title">Способ оплаты</div>
            <div class="form">
                <div class="form__select">
                    <p style="margin-bottom: 50px;">Выберите способ оплаты</p>
                </div>
            </div>
		<?
